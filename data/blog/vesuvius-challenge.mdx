...
_The three steps in the process are : 
...
3. Ink Detection: identifying the inked regions in the flattened surface volume using a machine learning model_
